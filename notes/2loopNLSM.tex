...
\begin{equation*}
  ...
  \begin{tikzpicture}
    ...
    \pgfmathsetmacro{\cl}{1.1};
      ...
      \draw[ultra thick] (i6) to[out=-60,in=180+60] (i5);
      \draw[dashed,ultra thick,nhp4] (0,0) -- (c1);
      \draw[dashed,ultra thick,nhp4] (0,0) -- (c2);
      \draw[dashed,ultra thick,nhp4] (0,0) -- (c3);
      \draw[dashed,ultra thick,nhp4] (0,0) -- (c4);
      \draw[dashed,ultra thick,nhp4] (c5) -- ++(90:0.7*\cl);
...
\begin{equation}
  \KissingTriangles
  =
  \frac{1}{(\textcolor{nhpBlue}{\ell_1})^2} \
  n \left[
    \KTDBContrib{1}{2}{3}{4}
  \right]
  +
  \frac{1}{(\textcolor{nhpBlue}{\ell_2})^2} \
...
As a first attempt at such a tame non-local representation, 
