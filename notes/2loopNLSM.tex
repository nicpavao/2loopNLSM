...
convenient to project onto a specific basis of the Del
...
Even beginning at one loop, we will encounter types of cuts that are
...
\end{tikzpicture}
\ni
\frac{\delta(\textcolor{cut-color}{k_1^2})}{\textcolor{ucp-color}{k_1^2}}
n \left[
  \begin{tikzpicture}
    \ver{e1}{-1,0};
    \ver{e2}{-0.6,0.4};
