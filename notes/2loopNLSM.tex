...
This trivially enforces Lorenz gauge while the vanishing field strength condition...


The Lagrangian for Zakharov-Mikhailov (ZM) theory is a simple $SU(N)$ scalar theory defined in two spacetime dimensions:
\begin{eBox}
\be
...
\ee
This important property is due to momentum conservation alone and does not need any additional kinematic constraints to satisfy the duality. In addition to anti-symmetry, the cubic graphs will satisfy jacobi off-shell on any internal edge due to the delta function identity of 2D Levi-Civita symbols (TODO:  show the identity, say that the following is Schouten, cite Schouten?, comment on addition of masses):
\be
