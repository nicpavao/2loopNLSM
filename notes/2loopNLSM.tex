...
\end{split}\right]
\ee
there are only 365 parameters of generalized gauge freedom. An overview of ZM theory and its color-dual construction can be found at the end of \cref{sec:CKLagrangians}.
