...
\nhp{Alex, fix the scaling to get the boxes to fit}
\be
\CrossedBoxGraphSym{1}{2}{3}{4}\!\! \sim\!\! \CrossedBoxGraphSym{2}{1}{3}{4} 
\text{ and }
\CrossedBoxGraphSym{1}{2}{3}{4} \!\!\sim\!\! \CrossedBoxGraphSym{2}{1}{4}{3}
\ee
...
%\end{equation}
which are just functional relabelings of external legs, $\{1234\} \to \{2134\}$ and $\{1234\} \to \{1243\}$.
...
their orientations.  Once imposing symmetry relations, the crossed box can be expressed in terms of the double box
and penta-triangle, thus imposing non-trivial constraints on the
ansatz. 
\nhp{Someone add in comment here about how symmetry relations imposes constraints of jacobi from equation above}.
%\ace{I'm not quite sure why the signs are mentioned in the
%  previous sentence?}
...
products of momenta.  The basis of momentum invariants for the numerators assigned to both of
...
% just as the product of three-point scalar amplitudes will.  However, for the
...
\begin{equation}
N^{\text{YM}}\left[\NLSMBasisDoubleBox \right]\text{ and }N^{\text{YM}}\left[\NLSMBasisPentaTriangle \right]\in \text{span}\left\{(\varepsilon_i \varepsilon_j) , (k_i \varepsilon_j), (k_ik_j)\right\}
  \label{eq:ym-basis}
\end{equation}
