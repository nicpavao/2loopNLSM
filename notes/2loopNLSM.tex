...
\title{\center  \fontsize{18.8}{20} \selectfont  Globally Color-Dual Multi-Loop Integrands}
...
these NLSM numerators with themselves, pure Yang-Mills, and
  ...
  Applying our loop-level bootstrap, we exhaustively search the space of integrands consistent with point-like interactions and find that two-loop four-point pure Yang-Mills fails to satisfy global color-kinematics duality, completing a search previously initiated in the literature. 
