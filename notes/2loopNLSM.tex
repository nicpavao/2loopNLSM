...
be abandoned for color-dual constructions of multi-loop Yang-Mills. \footnote{An example of this can already be found in the literature, where Locality is relaxed in \cite{Mogull:2015adi} in
  order to obtain color-dual two-loop integrands with on-shell 4D states.} To expand the available function space, we propose that one should consider including rational functions of kinematics, rather than just polynomials.
