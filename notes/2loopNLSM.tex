...
\end{equation}
where $A_\mu$ is in Lorenz gauge.
\jm{I'm pretty sure A has to be in Lorenz gauge.}
...
\end{equation}
This integrand numerator with internal scalar loop is precisely what one would obtain from the Feynman rules of YZ-theory, absent the $XZ$ internal vector loop. For more background, we refer the reader to \cref{sec:CKLagrangians}. 
\begin{equation}
