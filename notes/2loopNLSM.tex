...
\item  \textbf{Relabeling}: The diagram numerators are only a function of the
  diagram's topology and labeling.
\item  \textbf{Symmetries}: The diagram numerators are invariant under the
...
The other cuts besides (b) and (c) are either pathological or vanish because they involve a 3pt point on-shell amplitude (which vanishes in any scalar theory).
