...
An example Jacobi relation will be presented in \sect{}.
...
In theories where the kinematic algebra is known, it is often the algebra of volume preserving diffeomorphisms \citepls{Donal Ricardo SDYM, Henrik Maor CS, Cliff James NLSM, Cliff et al ZM}.
...
The double copy can be proven at tree level using the KLT relations but there is significant evidence that the double copy persists to all loop orders \citepls{KLT, ``M. Kiermaier, Gravity as the square of gauge theory, in Amplitudes 2010, Queen Mary,
University of London,
https://strings.ph.qmul.ac.uk/?theory/Amplitudes2010/Talks/MK2010.pdf '',
any loop papers we want}.
...
A fully color dressed tree amplitude $\mathcal{A}$ in YM or NLSM can be decomposed in terms of the trace basis
\be
\mathcal{A}_m = \sum Tr(...) A[]
\ee
where, because of the cyclicity of the trace, $(n-1)!$ of the color-ordered partial amplitudes $A$ form a basis.
Any color factor can be written in terms of the basis of $(n-2)!$ DDM half ladders, indicating that there are further linear relations (the KK relations) amongst the partial amplitudes (cite DDM, KK).
The KLT relations (or tree-level color-kinematics duality) means that there are even more linear relations among the partial amplitudes, meaning that you can go to a basis of $(n-3)!$.
At tree level, it is enough to specify the numerators of the half ladder topologies.
By repeated application of the Jacobi identity, any other topology can be obtained from the half ladder.
The same is true for 1-loop and the $n$-gon.

Do 4pt tree example
$c_s+c_t+c_u=0$ and $n_s+n_t+n_u=0$
NLSM 4pt CK numerators and DC to sGal
