...
%%%%
% Basis for both diagrams {d[p[1], p[3]], d[p[1], p[6]], d[p[1],
% p[7]], d[p[2], p[3]], d[p[2], p[6]], d[p[2], p[7]], d[p[3], p[6]],
% d[p[3], p[7]], d[p[6], p[6]], d[p[6], p[7]], d[p[7], p[7]]}
%%%%
...
be abandoned.\footnote{Locality is relaxed in \cite{Mogull:2015adi} in
  order to obtain color-dual 2-loop integrands.}
