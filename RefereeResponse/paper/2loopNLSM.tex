...
theories.
However, in sharp contrast to both sYM \cite{BRY} and NLSM, we find that Yang-Mills does %Referee edit.  Am I citing the right paper?
...
numerators. %Alex, can you add more relevant references to the next two sentences?
...
manifest Lorentz invariance \cite{Square, WeinzierlBCJLagrangian,
...
through 4pt 4-loop \cite{Bern:2012uf}. %What paper should we cite?
While a local representation has not been found at five loops, the
double copy has still be performed
...
Ref.~\cite{Bern:2015ooa}.\footnote{As mentioned at the beginning of
  ...
  \cite{GeneralizedDoubleCopyFiveLoops}.} %Referee edits.  What papers should we cite?
