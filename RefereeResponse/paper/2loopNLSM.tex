...
internal edges. Therefore, by a simple weight counting argument, one can see that
...
Note that NLSM and sYM do not suffer from this failure, suggesting that they are more privileged theories in some sense.%Referee edit
